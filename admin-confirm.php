...
$sql = "INSERT IGNORE INTO `alladventures`(`heading`, `tripDate`, `duration`, `summary`) VALUES ('$heading','$tripDate','$duration','$summary')";

if ($conn->query($sql) === TRUE) {
  $dataSubmit = "Data has been submitted to the database successfully.";
