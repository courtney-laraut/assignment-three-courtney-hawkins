<form id="support-form" action="problem.php" method="post">
        ...
        <label  class="support-label" for="fName">First Name:</label>
            <input class="support-inputs" type="text" id="fName" name="fName" required maxlength=25><br>
        <label  class="support-label" for="lName">Last Name:</label>
            <input class="support-inputs" type="text" id="lName" name="lName" required required maxlength=25><br>
